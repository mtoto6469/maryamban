...
define(function (require) {
    ...
    var GlobalModel = Model.extend({
        ...
        mergeOption: function (newOption) {
            ...
            // 如果不存在对应的 components model 则直接 merge
    ...
    function mergeTheme(option, theme) {
        for (var name in theme) {
            // 如果有 components model 则把具体的 merge 逻辑交给该 model 处理
    ...
    function makeKeyInfo(mainType, mapResult) {
        // We use this id to hash components models and view instances
    ...
    function assertSeriesInitialized(ecModel) {
        // Components that use _seriesIndices should depends on series components,
