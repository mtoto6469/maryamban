define(function(require) {
    ...
    // Spectial components id start with \0ec\0, see echarts/model/Global.js~hasInnerId
    ...
    DataZoom.defaultOption = {
        ...
        // Icon group
        icon: {
            zoom: 'M0,13.5h26.9 M13.5,26.9V0 M32.1,13.5H58V58h33.5 V32.1',
            back: 'M22,1.4L9.9,13.5l12.3,12.3 M10.3,13.5H54.9v44.6 h30.3v-26'
        },
        title: {
            zoom: '区域缩放',
            back: '区域缩放还原'
