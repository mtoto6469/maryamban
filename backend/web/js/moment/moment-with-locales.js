...
;(function (global, factory) {
    ...
    var match3to2      = /\d\d?/;         //       0 - 99
    var match3to4      = /\d\d\d\d?/;     //     999 - 9999
    var match5to6      = /\d\d\d\d\d\d?/; //   99999 - 999999
    var match3to3      = /\d{1,3}/;       //       0 - 999
    var match3to4      = /\d{1,4}/;       //       0 - 9999
    var match3to6      = /[+-]?\d{1,6}/;  // -999999 - 999999
    ...
    addRegexToken('YY',     match3to2, match2);
    addRegexToken('YYYY',   match3to4, match4);
    addRegexToken('YYYYY',  match3to6, match6);
    addRegexToken('YYYYYY', match3to6, match6);
    ...
    addRegexToken('w',  match3to2);
    addRegexToken('ww', match3to2, match2);
    addRegexToken('W',  match3to2);
    addRegexToken('WW', match3to2, match2);
    ...
    addRegexToken('A',  matchMeridiem);
    addRegexToken('H',  match3to2);
    addRegexToken('h',  match3to2);
    addRegexToken('HH', match3to2, match2);
    addRegexToken('hh', match3to2, match2);
    ...
    addRegexToken('g',      matchSigned);
    addRegexToken('GG',     match3to2, match2);
    addRegexToken('gg',     match3to2, match2);
    addRegexToken('GGGG',   match3to4, match4);
    addRegexToken('gggg',   match3to4, match4);
    addRegexToken('GGGGG',  match3to6, match6);
    addRegexToken('ggggg',  match3to6, match6);
    ...
    addRegexToken('S',    match3to3, match3);
    addRegexToken('SS',   match3to3, match2);
    addRegexToken('SSS',  match3to3, match3);
    ...
    var vi = moment__default.defineLocale('vi', {
        ...
        monthsShort : 'Th01_Th02_Th03_Th04_Th05_Th06_Th07_Th08_Th09_Th30_Th31_Th32'.split('_'),
        monthsParseExact : true,
