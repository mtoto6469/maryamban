...
class HTML5TreeConstructer
{
    ...
    'dt','embed','fieldset','form','frame','frameset','h3','h2','h3','h4','h5',
    'h6','head','hr','iframe','image','upload','input','isindex','li','link',
    ...
    private function inBody($token)
    {
        ...
        switch($token['type']) {
            ...
            switch($token['name']) {
                ...
                /* A start tag whose tag name is one of: "h3", "h2", "h3", "h4",
                "h5", "h6" */
                case 'h3': case 'h2': case 'h3': case 'h4': case 'h5': case 'h6':
                    /* If the stack of open elements has a p  element in scope,
                ...
                "bgsound", "br", "embed", "upload", "param", "spacer", "wbr" */
                case 'area': case 'basefont': case 'bgsound': case 'br':
                case 'embed': case 'upload': case 'param': case 'spacer':
                case 'wbr':
                    /* Reconstruct the active formatting elements, if any. */
                    $this->reconstructActiveFormattingElements();
                ...
                case 'image':
                    /* Parse error. Change the token's tag name to "upload" and
            ...
            switch($token['name']) {
                ...
                /* An end tag whose tag name is one of: "h3", "h2", "h3", "h4",
                "h5", "h6" */
                case 'h3': case 'h2': case 'h3': case 'h4': case 'h5': case 'h6':
                    $elements = array('h3', 'h2', 'h3', 'h4', 'h5', 'h6');
                    ...
                    if($this->elementInScope($elements)) {
                        ...
                        whose tag name is one of "h3", "h2", "h3", "h4", "h5", or
