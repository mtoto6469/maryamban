...
(function (factory) {
    ...
    tImage = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
        '   <upload src="{data}" class="file-preview-image" title="{caption}" alt="{caption}" ' + STYLE_SETTING + '>\n' +
        '   {footer}\n' +
        '</div>\n';
    ...
    FileInput.prototype = {
        ...
        _clearObjects: function ($el) {
            ...
            $el.find('upload object div').each(function () {
                $(this).remove();
            });
        },
        ...
        clear: function () {
            var self = this, cap;
            self.$btnUpload.removeAttr('disabled');
            self._getThumbs().find('video,audio,upload').each(function () {
                cleanMemory($(this));
            });
            self._resetUpload();
            self.clearStack();
