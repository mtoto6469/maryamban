...
class Crawler implements \Countable, \IteratorAggregate
{
     ...
     * Example:
     *
     *     $crawler->filter('h3')->each(function ($node, $i) {
     *         return $node->text();
     *     });
     *
     ...
     * Example:
     *
     * $crawler->filter('h3 a')->extract(array('_text', 'href'));
     *
    ...
    {
        $xpath = sprintf('descendant-or-self::upload[contains(normalize-space(string(@alt)), %s)]', static::xpathLiteral($value));
