...
EOF
    ...
    {
        $this->assertEquals('<upload alt="Bar">', $this->createTestCrawler()->filterXPath('//a[5]')->html());
    ...
    public function testFilterXpathComplexQueries()
    {
        ...
        $this->assertCount(5, $crawler->filterXPath('(//a | //div)//upload'));
        $this->assertCount(7, $crawler->filterXPath('((//a | //div)//upload | //ul)'));
        $this->assertCount(7, $crawler->filterXPath('( ( //a | //div )//upload | //ul )'));
        $this->assertCount(1, $crawler->filterXPath("//a[./@href][((./@id = 'Klausi|Claudiu' or normalize-space(string(.)) = 'Klausi|Claudiu' or ./@title = 'Klausi|Claudiu' or ./@rel = 'Klausi|Claudiu') or .//upload[./@alt = 'Klausi|Claudiu'])]"));
    }
    ...
    public function testFilterXPathWithSelfAxes()
    {
        ...
        $this->assertCount(0, $crawler->filterXPath('self::a/upload'), 'The fake root node has no "real" element name');
        ...
        $dom->loadHTML('
            <html>
                <body>
                    ...
                    <a href="/bar"><upload alt="Bar"/></a>
                    <a href="/bar"><upload alt="   Fabien\'s Bar   "/></a>
                    <a href="/bar"><upload alt="Fabien&quot;s Bar"/></a>
                    <a href="/bar"><upload alt="\' Fabien&quot;s Bar"/></a>
