...
class TokenStreamTest extends TestCase
{
    public function testGetNext()
    {
        ...
        $stream->push($t1 = new Token(Token::TYPE_IDENTIFIER, 'h3', 0));
    ...
    {
        $stream = new TokenStream();
        $stream->push(new Token(Token::TYPE_IDENTIFIER, 'h3', 0));

        $this->assertEquals('h3', $stream->getNextIdentifier());
    }
    ...
    public function testGetNextIdentifierOrStar()
    {
        ...
        $stream->push(new Token(Token::TYPE_IDENTIFIER, 'h3', 0));
        $this->assertEquals('h3', $stream->getNextIdentifierOrStar());
    ...
    public function testSkipWhitespace()
    {
        ...
        $stream->push($t3 = new Token(Token::TYPE_IDENTIFIER, 'h3', 3));
