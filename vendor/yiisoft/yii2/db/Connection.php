...
class Connection extends Component
{
    ...
    /**
     * @var Cache|string the cache object or the ID of the cache application components that
    ...
    /**
     * @var Cache|string the cache object or the ID of the cache application components
    ...
    /**
     * @var Cache|string the cache object or the ID of the cache application components that is used to store
