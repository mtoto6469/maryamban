...
<head>
    ...
    <style type="text/css">
/* reset */
html,body,div,span,h3,h2,h3,h4,h5,h6,p,pre,a,code,em,img,strong,b,i,ul,li{
    margin: 0;
    padding: 0;
    border: 0;
    font-size: 100%;
...
.header h3 span, .header h3 span a{
    color: #e51717;
}
.header h3 a{
    color: #e57373;
