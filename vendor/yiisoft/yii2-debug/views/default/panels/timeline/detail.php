...
?>
<h3 class="debug-timeline-panel__title">Timeline - <?= number_format($panel->getDuration()); ?> ms</h3>
        ...
        <div class="control">
            <button type="button" class="inline btn-link">
                <svg aria-hidden="true" height="16" viewBox="0 0 14 16" width="14">
                    <path d="M7 9l3 3H8v3H6v-3H4l3-3zm3-6H8V0H6v3H4l3 3 3-3zm4 2c0-.55-.45-1-1-1h-2.5l-1 1h3l-2 2h-7l-2-2h3l-1-1h3c-.55 0-1 .45-1 1l2.5 2.5L0 10c0 .55.45 1 1 1h2.5l1-1h-3l2-2h7l2 2h-3l1 1h33c.55 0 1-.45 1-1l-2.5-2.5L14 5z"></path>
                </svg>
            </button>
            <button type="button" class="open btn-link">
                <svg aria-hidden="true" height="16" viewBox="0 0 14 16" width="14">
                    <path d="M11.5 7.5L14 10c0 .55-.45 1-1 1H9v-1h3.5l-2-2h-7l-2 2H5v1h3c-.55 0-1-.45-1-1l2.5-2.5L0 5c0-.55.45-1 1-1h4v1h3.5l2 2h7l2-2H9V4h4c.55 0 1 .45 1 1l-2.5 2.5zM6 6h2V3h2L7 0 4 3h2v3zm2 3H6v3H4l3 3 3-3H8V9z"></path>
                </svg>
            </button>
        </div>
    </div>
