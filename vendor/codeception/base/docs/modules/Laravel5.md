...
$I->dontSee('Sign Up','h3');                  // I can suppose it's not a signup page
$I->dontSee('Sign Up','//body/h3');           // with XPath
$I->dontSee('Sign Up', ['css' => 'body h3']); // with strict CSS locator
```
...
```php
<?php
$I->dontSeeInSource('<h3>Green eggs &amp; ham</h3>');
```
...
``` php
<?php
$heading = $I->grabTextFrom('h3');
$heading = $I->grabTextFrom('descendant-or-self::h3');
...
$I->see('Sign Up', 'h3');                 // I can suppose it's a signup page
$I->see('Sign Up', '//body/h3');          // with XPath
$I->see('Sign Up', ['css' => 'body h3']); // with strict CSS locator
```
...
``` php
<?php
$I->seeInSource('<h3>Green eggs &amp; ham</h3>');
```
