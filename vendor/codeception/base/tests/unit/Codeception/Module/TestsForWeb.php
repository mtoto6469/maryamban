...
abstract class TestsForWeb extends \Codeception\TestCase\Test
{
    ...
    public function testSee()
    {
        ...
        $this->module->see('Welcome to test app!', 'h3');
        ...
        $this->module->dontSee('valuable', 'h3');
    ...
    {
        $this->module->amOnPage('/');
        $this->module->seeInSource('<h3>Welcome to test app!</h3>');
    ...
    {
        $this->module->amOnPage('/');
        $result = $this->module->grabTextFrom('h3');
        $this->assertEquals("Welcome to test app!", $result);
        $result = $this->module->grabTextFrom('descendant-or-self::h3');
        $this->assertEquals("Welcome to test app!", $result);
