...
export var match3to2      = /\d\d?/;         //       0 - 99
export var match3to4      = /\d\d\d\d?/;     //     999 - 9999
export var match5to6      = /\d\d\d\d\d\d?/; //   99999 - 999999
export var match3to3      = /\d{1,3}/;       //       0 - 999
export var match3to4      = /\d{1,4}/;       //       0 - 9999
export var match3to6      = /[+-]?\d{1,6}/;  // -999999 - 999999
