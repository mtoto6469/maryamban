  ...
  Cropper.prototype = {
    ...
    init: function () {
      ...
      if ($this.is('img')) {
        ...
        // Should use `$.fn.attr` here. e.g.: "upload/picture.jpg"
    ...
    clone: function () {
      ...
      this.$clone = $clone = $('<upload' + getCrossOrigin(crossOrigin) + ' src="' + (crossOriginUrl || url) + '">');
    ...
    initPreview: function () {
      ...
      this.$clone2 = $clone2 = $('<upload' + crossOrigin + ' src="' + url + '">');
      ...
      this.$preview.each(function () {
        ...
        /**
         * Override upload element styles
         * Add `display:block` to avoid margin top issue
         * (Occur only when margin-top <= -height)
         */
        $this.html(
          '<upload' + crossOrigin + ' src="' + url + '" style="' +
