                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
<!--                                <h1><span>مریم</span>بانو</h1>-->
<!--                                <h2>فروشگاه مریم بانو</h2>-->
<!--                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>-->
<!--                                <button type="button" class="btn btn-default get">Get it now</button>-->
                            </div>
                            <div class="col-sm-6">
                                <img src="<?=Yii::$app->request->hostInfo?>/upload/images/home/girl1.jpg" class="girl img-responsive" alt="" />
                                <img src="<?=Yii::$app->request->hostInfo?>/upload/images/home/pricing.png"  class="pricing" alt="" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="col-sm-6">
...
<!--                                <button type="button" class="btn btn-default get">Get it now</button>-->
                            ...
                            <div class="col-sm-6">
                                <img src="<?=Yii::$app->request->hostInfo?>/upload/images/home/girl2.jpg" class="girl img-responsive" alt="" />
                                <img src="<?=Yii::$app->request->hostInfo?>/upload/images/home/pricing.png"  class="pricing" alt="" />
                            </div>
                        </div>
...
<!--                                <button type="button" class="btn btn-default get">Get it now</button>-->
                            ...
                            <div class="col-sm-6">
                                <img src="<?=Yii::$app->request->hostInfo?>/upload/images/home/girl3.jpg" class="girl img-responsive" alt="" />
                                <img src="<?=Yii::$app->request->hostInfo?>/upload/images/home/pricing.png" class="pricing" alt="" />
                            </div>
                        </div>
                                ...
                                <div class="single-products">
                                    <div class="productinfo text-center" style="height:350px!important;">
                                        ...
                                        <a href="<?= $url->createAbsoluteUrl(['bag/pro_color', 'id' => $p->id]) ?>"
                                           class="btn btn-default add-to-cart"><i class="fa fa-user"></i>رنگ بندی</a>
                                    </div>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center" style="height:350px!important;">
                                            ...
                                            echo '<br>';
                                            ?>
                                            <a href="<?= $url->createAbsoluteUrl(['bag/pack_color', 'id' => $p->id]) ?>"
                                               class="btn btn-default add-to-cart"><i class="fa fa-user"></i>رنگ
                                                بندی</a>
                                        </div>
                                        <div class="product-overlay">
