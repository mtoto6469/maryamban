...
<div class="tblpardakht-view" style="text-align: right;">
    ...
    <p>
        ...
        <?= Html::a(Yii::t('app', 'اتمام خرید'), ['site/index'], ['class' => 'btn btn-success']) ?>
    </p>
    <div class="alert alert-success">پس از تایید مدیر به درخواست شما رسیدگی میشود<br>میتوانید از پروفایل خود پیگیری را انجام دهید</div>
