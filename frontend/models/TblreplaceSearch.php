...
/**
 * TblreplaceSearch represents the model behind the search form about `frontend\models\Tblreplace`.
 */
class TblreplaceSearch extends Tblreplace
{
    ...
    {
        return [
            [['id', 'id_user', 'id_pro', 'id_fac', 'category', 'confirm', 'post_price', 'enabel_view'], 'integer'],
    ...
    {
        $query = Tblreplace::find()->where(['id_user'=>Yii::$app->user->getId()]);
